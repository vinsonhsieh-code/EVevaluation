...
# 2. 目標車速標籤 - 往「左上方 (ax=-50, ay=-65)」拉高，主動避開右側的極速標籤
...
# 3. 馬達極限車速標籤 - 往「右上方 (ax=60, ay=-45)」拉出，利用右側的空白區域
