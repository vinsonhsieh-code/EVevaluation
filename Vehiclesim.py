...
**v2.2.1 (2026-04-12) - 圖形標示修訂版**
- 還原圖1與圖2豐富的獨立標籤樣式（包含目標轉速與極速點）。
- 於圖1與圖2新增「負載線」與「最大扭矩曲線」之交點標示，並秀出精確數值。
- 其餘物理運算與能耗估算嚴格維持 v2.2 穩定版。
